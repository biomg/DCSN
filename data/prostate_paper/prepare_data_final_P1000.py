...
data_dir = r"C:\Users\h'p\Desktop\pnet_prostate_paper-master\data\prostate_paper\raw_data"
print(data_dir)
...
def prepare_design_matrix_crosstable():
    ...
    filename = join(r"C:\Users\h'p\Desktop\pnet_prostate_paper-master\data\prostate_paper\processed", 'P1000_final_analysis_set_cross_' + ext + '.csv')
...
def prepare_response():
    ...
    response.to_csv(join(r"C:\Users\h'p\Desktop\pnet_prostate_paper-master\data\prostate_paper\processed", 'response_paper.csv'), index=False)
...
def prepare_cnv():
    ...
    df = df.T
    df = df.fillna(0.)
    filename = join(r"C:\Users\h'p\Desktop\pnet_prostate_paper-master\data\prostate_paper\processed", 'P1000_data_CNA_paper.csv')
    df.to_csv(filename)
...
def prepare_cnv_burden():
    ...
    filename = join(r"C:\Users\h'p\Desktop\pnet_prostate_paper-master\data\prostate_paper\processed", 'P1000_data_CNA_burden.csv')
